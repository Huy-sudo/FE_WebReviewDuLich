...
function PostDetail(props) {
  const post = {
    ...
    imgsrc: "https://dbsreal.com/wp-content/uploads/2020/12/bien-hoa-universe-complex-tong-quan-can-ho.jpg",
    ...
    <div className={classes["post-wrapper"]}>
      ...
      <div className={classes.info}>
        ...
        <p className={classes.rating}> 
          Đánh giá: <span style={{ color: "#FFBE0D", fontWeight: "bold" }}>{post.rating}</span>
        </p>
